...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.tracking_data_group_box = QGroupBox(self.groupBox_4)
        self.tracking_data_group_box.setObjectName(u"tracking_data_group_box")
        self.tracking_data_group_box.setMinimumSize(QSize(185, 0))
        self.tracking_data_group_box.setMaximumSize(QSize(185, 16777215))
        self.tracking_data_group_box.setFlat(True)
        self.verticalLayout_12 = QVBoxLayout(self.tracking_data_group_box)
        self.verticalLayout_12.setObjectName(u"verticalLayout_12")
        self.tracker_data_plain_text = QPlainTextEdit(self.tracking_data_group_box)
        ...
        self.horizontalLayout.addWidget(self.tracking_data_group_box)
        ...
        self.roi_image_group_box = QGroupBox(self.groupBox_4)
        self.roi_image_group_box.setObjectName(u"roi_image_group_box")
        sizePolicy1 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.roi_image_group_box.sizePolicy().hasHeightForWidth())
        self.roi_image_group_box.setSizePolicy(sizePolicy1)
        self.roi_image_group_box.setMinimumSize(QSize(350, 0))
        self.roi_image_group_box.setMaximumSize(QSize(500, 500))
        self.verticalLayout_24 = QVBoxLayout(self.roi_image_group_box)
        self.verticalLayout_24.setObjectName(u"verticalLayout_24")
        self.verticalLayout_24.setSizeConstraint(QLayout.SizeConstraint.SetMinimumSize)
        self.verticalLayout_24.setContentsMargins(15, 4, 15, 4)
        self.roi_label = QLabel(self.roi_image_group_box)
        ...
        self.roi_label.setMinimumSize(QSize(350, 250))
        ...
        self.verticalLayout_24.addWidget(self.roi_label)
        ...
        self.horizontalLayout_14.setSizeConstraint(QLayout.SizeConstraint.SetFixedSize)
        self.horizontalLayout_14.setContentsMargins(15, -1, -1, -1)
        self.roi_brightness_label = QLabel(self.roi_image_group_box)
        self.roi_brightness_label.setObjectName(u"roi_brightness_label")
        self.roi_brightness_label.setMaximumSize(QSize(100, 15))

        self.horizontalLayout_14.addWidget(self.roi_brightness_label)

        self.roi_brightness_value_label = QLabel(self.roi_image_group_box)
        self.roi_brightness_value_label.setObjectName(u"roi_brightness_value_label")
        self.roi_brightness_value_label.setMaximumSize(QSize(16777215, 15))

        self.horizontalLayout_14.addWidget(self.roi_brightness_value_label)


        self.verticalLayout_14.addLayout(self.horizontalLayout_14)

        self.roi_frame_brightness_slider = QSlider(self.roi_image_group_box)
        ...
        self.verticalLayout_23.setContentsMargins(10, -1, 10, 6)
        self.horizontalLayout_15 = QHBoxLayout()
        self.horizontalLayout_15.setObjectName(u"horizontalLayout_15")
        self.horizontalLayout_15.setContentsMargins(15, -1, -1, -1)
        self.roi_contrast_label = QLabel(self.roi_image_group_box)
        self.roi_contrast_label.setObjectName(u"roi_contrast_label")
        self.roi_contrast_label.setMaximumSize(QSize(100, 15))

        self.horizontalLayout_15.addWidget(self.roi_contrast_label)

        self.roi_contrast_value_label = QLabel(self.roi_image_group_box)
        self.roi_contrast_value_label.setObjectName(u"roi_contrast_value_label")
        self.roi_contrast_value_label.setMaximumSize(QSize(16777215, 15))

        self.horizontalLayout_15.addWidget(self.roi_contrast_value_label)


        self.verticalLayout_23.addLayout(self.horizontalLayout_15)

        self.roi_frame_contrast_slider = QSlider(self.roi_image_group_box)
        ...
        self.verticalLayout_23.addWidget(self.roi_frame_contrast_slider)


        self.verticalLayout_24.addLayout(self.verticalLayout_23)


        self.horizontalLayout.addWidget(self.roi_image_group_box)
        ...
        self.controls_box = QGroupBox(self.groupBox_2)
        self.controls_box.setObjectName(u"controls_box")
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.controls_box.sizePolicy().hasHeightForWidth())
        self.controls_box.setSizePolicy(sizePolicy2)
        self.controls_box.setMinimumSize(QSize(170, 240))
        self.controls_box.setMaximumSize(QSize(170, 16777215))
        self.controls_box.setFlat(False)
        self.verticalLayout = QVBoxLayout(self.controls_box)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(-1, 9, -1, -1)
        self.connect_button = QPushButton(self.controls_box)
        ...
        self.cancel_connection_button = QPushButton(self.controls_box)
        ...
        self.toggle_button = QPushButton(self.controls_box)
        ...
        self.reboot_server_button = QPushButton(self.controls_box)
        ...
        self.horizontalLayout_4.addWidget(self.controls_box)
        ...
        self.tracking_tab.setObjectName(u"tracking_tab")
        self.horizontalLayout_3 = QHBoxLayout(self.tracking_tab)
        self.horizontalLayout_3.setObjectName(u"horizontalLayout_3")
        self.tracking_group_box = QGroupBox(self.tracking_tab)
        ...
        self.training_count_label = QLabel(self.tracker_params_group_box)
        self.training_count_label.setObjectName(u"training_count_label")
        font2 = QFont()
        font2.setPointSize(8)
        self.training_count_label.setFont(font2)

        self.verticalLayout_11.addWidget(self.training_count_label)
        ...
        self.alpha_smoothing_label = QLabel(self.tracker_params_group_box)
        self.alpha_smoothing_label.setObjectName(u"alpha_smoothing_label")
        self.alpha_smoothing_label.setFont(font2)

        self.verticalLayout_11.addWidget(self.alpha_smoothing_label)
        ...
        self.verticalLayout_11.addWidget(self.sigma_factor_label)
        ...
        self.verticalLayout_4.setContentsMargins(4, 0, 4, 24)
        ...
        self.skip_frame_label = QLabel(self.kalman_group_box)
        self.skip_frame_label.setObjectName(u"skip_frame_label")
        self.skip_frame_label.setMaximumSize(QSize(16777215, 20))
        self.skip_frame_label.setFont(font2)

        self.verticalLayout_4.addWidget(self.skip_frame_label)
        ...
        self.verticalLayout_9 = QVBoxLayout(self.params_tab)
        self.verticalLayout_9.setObjectName(u"verticalLayout_9")
        self.params_group_box = QGroupBox(self.params_tab)
        ...
        self.stream_resolution_label = QLabel(self.stream_quality_group_box)
        self.stream_resolution_label.setObjectName(u"stream_resolution_label")
        self.stream_resolution_label.setMaximumSize(QSize(16777215, 15))
        self.stream_resolution_label.setFont(font1)

        self.verticalLayout_13.addWidget(self.stream_resolution_label)
        ...
        self.bitrate_label = QLabel(self.stream_quality_group_box)
        self.bitrate_label.setObjectName(u"bitrate_label")
        self.bitrate_label.setMaximumSize(QSize(16777215, 15))
        self.bitrate_label.setFont(font1)

        self.verticalLayout_13.addWidget(self.bitrate_label)
        ...
        self.other_group_box = QGroupBox(self.params_group_box)
        self.other_group_box.setObjectName(u"other_group_box")
        sizePolicy1.setHeightForWidth(self.other_group_box.sizePolicy().hasHeightForWidth())
        self.other_group_box.setSizePolicy(sizePolicy1)
        self.other_group_box.setFlat(False)
        self.verticalLayout_10 = QVBoxLayout(self.other_group_box)
        self.verticalLayout_10.setObjectName(u"verticalLayout_10")
        self.fps_label = QLabel(self.other_group_box)
        self.fps_label.setObjectName(u"fps_label")
        self.fps_label.setFont(font1)

        self.verticalLayout_10.addWidget(self.fps_label)

        self.stream_fps_line_edit = QLineEdit(self.other_group_box)
        ...
        self.view_method_group_box = QGroupBox(self.other_group_box)
        self.view_method_group_box.setObjectName(u"view_method_group_box")
        sizePolicy4 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Maximum)
        sizePolicy4.setHorizontalStretch(0)
        sizePolicy4.setVerticalStretch(0)
        sizePolicy4.setHeightForWidth(self.view_method_group_box.sizePolicy().hasHeightForWidth())
        self.view_method_group_box.setSizePolicy(sizePolicy4)
        self.verticalLayout_15 = QVBoxLayout(self.view_method_group_box)
        self.verticalLayout_15.setObjectName(u"verticalLayout_15")
        self.stream_check_box = QCheckBox(self.view_method_group_box)
        ...
        self.transmitter_check_box = QCheckBox(self.view_method_group_box)
        ...
        self.verticalLayout_10.addWidget(self.view_method_group_box)


        self.horizontalLayout_7.addWidget(self.other_group_box)
        ...
        self.horizontalLayout_12 = QHBoxLayout(self.display_tab)
        self.horizontalLayout_12.setObjectName(u"horizontalLayout_12")
        self.groupBox_5 = QGroupBox(self.display_tab)
        ...
        self.preview_params_group_box = QGroupBox(self.display_tab)
        self.preview_params_group_box.setObjectName(u"preview_params_group_box")
        self.preview_params_group_box.setEnabled(True)
        self.preview_params_group_box.setMaximumSize(QSize(200, 16777215))
        self.verticalLayout_21 = QVBoxLayout(self.preview_params_group_box)
        self.verticalLayout_21.setObjectName(u"verticalLayout_21")
        self.margins_group_box = QGroupBox(self.preview_params_group_box)
        self.margins_group_box.setObjectName(u"margins_group_box")
        self.margins_group_box.setEnabled(False)
        self.verticalLayout_22 = QVBoxLayout(self.margins_group_box)
        ...
        self.margin_top_label = QLabel(self.margins_group_box)
        self.margin_top_label.setObjectName(u"margin_top_label")
        self.margin_top_label.setMaximumSize(QSize(16777215, 20))
        self.margin_top_label.setFont(font3)
        self.margin_top_label.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.verticalLayout_17.addWidget(self.margin_top_label)

        self.frame_upper_border_line_edit = QLineEdit(self.margins_group_box)
        ...
        self.margin_bottom_label = QLabel(self.margins_group_box)
        self.margin_bottom_label.setObjectName(u"margin_bottom_label")
        self.margin_bottom_label.setMaximumSize(QSize(16777215, 20))
        self.margin_bottom_label.setFont(font3)
        self.margin_bottom_label.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.verticalLayout_18.addWidget(self.margin_bottom_label)

        self.frame_lower_border_line_edit = QLineEdit(self.margins_group_box)
        ...
        self.margin_right_label = QLabel(self.margins_group_box)
        self.margin_right_label.setObjectName(u"margin_right_label")
        self.margin_right_label.setMaximumSize(QSize(16777215, 20))
        self.margin_right_label.setFont(font3)
        self.margin_right_label.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.verticalLayout_20.addWidget(self.margin_right_label)

        self.frame_right_border_line_edit = QLineEdit(self.margins_group_box)
        ...
        self.margin_left_label = QLabel(self.margins_group_box)
        self.margin_left_label.setObjectName(u"margin_left_label")
        self.margin_left_label.setMaximumSize(QSize(16777215, 20))
        self.margin_left_label.setFont(font3)
        self.margin_left_label.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.verticalLayout_19.addWidget(self.margin_left_label)

        self.frame_left_border_line_edit = QLineEdit(self.margins_group_box)
        ...
        self.verticalLayout_21.addWidget(self.margins_group_box)

        self.keep_frame_aspect_ratio_radio_button = QRadioButton(self.preview_params_group_box)
        ...
        self.change_frame_borders_push_button = QPushButton(self.preview_params_group_box)
        ...
        self.horizontalLayout_12.addWidget(self.preview_params_group_box)

        self.tabWidget.addTab(self.display_tab, "")
        self.coeffs_tab = QWidget()
        self.coeffs_tab.setObjectName(u"coeffs_tab")
        self.verticalLayout_8 = QVBoxLayout(self.coeffs_tab)
        self.verticalLayout_8.setObjectName(u"verticalLayout_8")
        self.cfs_group_box = QGroupBox(self.coeffs_tab)
        ...
        self.tabWidget.addTab(self.coeffs_tab, "")

        self.horizontalLayout_4.addWidget(self.tabWidget)

        self.debug_messages_group_box = QGroupBox(self.groupBox_2)
        self.debug_messages_group_box.setObjectName(u"debug_messages_group_box")
        self.debug_messages_group_box.setMaximumSize(QSize(16777215, 16777215))
        self.verticalLayout_3 = QVBoxLayout(self.debug_messages_group_box)
        self.verticalLayout_3.setObjectName(u"verticalLayout_3")
        self.debug_plain_text_edit = QPlainTextEdit(self.debug_messages_group_box)
        ...
        self.horizontalLayout_4.addWidget(self.debug_messages_group_box)
        ...
        self.horizontalSpacer_7 = QSpacerItem(1078, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_13.addItem(self.horizontalSpacer_7)

        self.language_tool_button = QToolButton(self.groupBox)
        self.language_tool_button.setObjectName(u"language_tool_button")
        self.language_tool_button.setIconSize(QSize(16, 16))

        self.horizontalLayout_13.addWidget(self.language_tool_button)
    ...
    def retranslateUi(self, Widget):
        ...
        self.tracking_data_group_box.setTitle(QCoreApplication.translate("Widget", u"\u0414\u0430\u043d\u043d\u044b\u0435 \u043e\u0442\u0441\u043b\u0435\u0436\u0438\u0432\u0430\u043d\u0438\u044f", None))
        self.view_label.setText("")
        self.roi_image_group_box.setTitle(QCoreApplication.translate("Widget", u"\u0418\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u0435 \u043e\u0431\u043b\u0430\u0441\u0442\u0438 \u0438\u043d\u0442\u0435\u0440\u0435\u0441\u0430", None))
        self.roi_label.setText("")
        self.roi_brightness_label.setText(QCoreApplication.translate("Widget", u"\u042f\u0440\u043a\u043e\u0441\u0442\u044c:", None))
        self.roi_brightness_value_label.setText("")
#if QT_CONFIG(tooltip)
        ...
        self.roi_contrast_label.setText(QCoreApplication.translate("Widget", u"\u041a\u043e\u043d\u0442\u0440\u0430\u0441\u0442\u043d\u043e\u0441\u0442\u044c:", None))
        self.roi_contrast_value_label.setText("")
        self.connection_label.setText(QCoreApplication.translate("Widget", u"\u041d\u0435\u0442 \u0441\u043e\u0435\u0434\u0438\u043d\u0435\u043d\u0438\u044f \u0441 \u0441\u0435\u0440\u0432\u0435\u0440\u043e\u043c", None))
        self.groupBox_2.setTitle("")
        self.controls_box.setTitle(QCoreApplication.translate("Widget", u"\u0423\u043f\u0440\u0430\u0432\u043b\u0435\u043d\u0438\u0435", None))
        ...
        self.training_count_label.setText(QCoreApplication.translate("Widget", u"\u0422\u0440\u0435\u043d\u0438\u0440. \u0438\u0437\u043e\u0431\u0440.", None))
        ...
        self.skip_frame_label.setText(QCoreApplication.translate("Widget", u"\u041f\u0440\u043e\u043f. \u043a\u0430\u0434\u0440\u043e\u0432:", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tracking_tab), QCoreApplication.translate("Widget", u"\u041e\u0442\u0441\u043b\u0435\u0436\u0438\u0432\u0430\u043d\u0438\u0435", None))
        ...
        self.stream_resolution_label.setText(QCoreApplication.translate("Widget", u"\u0420\u0430\u0437\u0440\u0435\u0448\u0435\u043d\u0438\u0435 \u043f\u043e\u0442\u043e\u043a\u0430", None))
        self.bitrate_label.setText(QCoreApplication.translate("Widget", u"\u0411\u0438\u0442\u0440\u0435\u0439\u0442 (\u043a\u0431\u0438\u0442/\u0441)", None))
        ...
        self.other_group_box.setTitle(QCoreApplication.translate("Widget", u"\u041f\u0440\u043e\u0447\u0435\u0435", None))
        self.fps_label.setText(QCoreApplication.translate("Widget", u"FPS", None))
        self.stream_fps_line_edit.setText(QCoreApplication.translate("Widget", u"30", None))
        self.view_method_group_box.setTitle(QCoreApplication.translate("Widget", u"\u041f\u043e\u043a\u0430\u0437 \u0438\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u044f", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.params_tab), QCoreApplication.translate("Widget", u"\u041f\u0430\u0440\u0430\u043c\u0435\u0442\u0440\u044b", None))
        ...
        self.preview_params_group_box.setTitle(QCoreApplication.translate("Widget", u"\u041f\u0430\u0440\u0430\u043c\u0435\u0442\u0440\u044b \u043f\u0440\u0435\u0432\u044c\u044e ", None))
        self.margins_group_box.setTitle(QCoreApplication.translate("Widget", u"\u041e\u0442\u0441\u0442\u0443\u043f\u044b", None))
        self.margin_top_label.setText(QCoreApplication.translate("Widget", u"\u0412\u0435\u0440\u0445", None))
        self.frame_upper_border_line_edit.setText(QCoreApplication.translate("Widget", u"0", None))
        self.margin_bottom_label.setText(QCoreApplication.translate("Widget", u"\u041d\u0438\u0437", None))
        self.frame_lower_border_line_edit.setText(QCoreApplication.translate("Widget", u"0", None))
        self.margin_right_label.setText(QCoreApplication.translate("Widget", u"\u041f\u0440\u0430\u0432\u043e", None))
        self.frame_right_border_line_edit.setText(QCoreApplication.translate("Widget", u"0", None))
        self.margin_left_label.setText(QCoreApplication.translate("Widget", u"\u041b\u0435\u0432\u043e", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.display_tab), QCoreApplication.translate("Widget", u"\u041e\u0442\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u0435", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.coeffs_tab), QCoreApplication.translate("Widget", u"\u041a\u043e\u044d\u0444\u0444\u0438\u0446\u0438\u0435\u043d\u0442\u044b", None))
        self.debug_messages_group_box.setTitle(QCoreApplication.translate("Widget", u"\u0421\u043e\u043e\u0431\u0449\u0435\u043d\u0438\u044f \u043e\u0442\u043b\u0430\u0434\u043a\u0438", None))
        self.groupBox.setTitle("")
        self.language_tool_button.setText("")
    # retranslateUi
